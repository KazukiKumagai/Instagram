...
class HomeViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func handleCommentButton(sender: UIButton, event:UIEvent){
        ...
        let commentViewContoroller = self.storyboard?.instantiateViewController(withIdentifier: "Comment") as! CommentViewController
        commentViewContoroller.postData = postData
        self.present(commentViewContoroller, animated: true, completion: nil)
    }
